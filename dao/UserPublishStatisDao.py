...
class UserPublishStatisDao(UserPublishDao):
    ...
    def __init__(self, hiveRunner: HiveRunner, yaml_file_path: AnyStr = './UserPublishDao.yaml'):
        super(UserPublishStatisDao, self).__init__(hiveRunner, yaml_file_path)
        self._database: AnyStr = self._config.get('statis_database')
